...
excerpt: 'In preparation: dynamic spectral analysis using windowed dynamic mode decomposition (WDMD) for time-dependent one-cell inversion radiation transport model.'
date: 2026-02-01
...
**Status:** Draft ready for placeholder text. Replace the fields above once the manuscript is submitted and a DOI / PDF is assigned.
